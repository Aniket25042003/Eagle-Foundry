  ...
  return (
    <div className="space-y-8">
      ...
      <Card>
        ...
        {joinRequestsLoading ? (
          <div className="h-24 animate-pulse rounded-xl bg-[var(--elements)]" />
          ...
          <div className="space-y-3">
            {pendingJoinRequests.map((request) => (
              <div
                key={request.id}
                className="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-[var(--border)] bg-[var(--elements)] px-3 py-2.5"
              >
                <div className="space-y-0.5">
                  <p className="text-sm text-[var(--foreground)]">{getRequesterName(request)}</p>
